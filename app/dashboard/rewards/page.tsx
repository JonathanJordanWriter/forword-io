    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1 mb-3">Earn points by completing tasks. Spend them to flip the book (for Author and Author Pro accounts only).</p>
          <a
            href="https://youtu.be/NhLEl_5X8vA"
            target="_blank"
