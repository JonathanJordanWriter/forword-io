...
- Phases 3–5 (Momentum): Podcast pitching (the book is published — immediate bookings are realistic), newsletter re-engagement campaigns, a reader giveaway to recruit new readers, and content series around the book's themes or behind-the-scenes story of how it got written and published.
...
- For authors at cover_design or published stage: include a reader giveaway task. Frame it as platform-flexible — the author should choose whichever channel fits their audience best. Suggest these options: Goodreads (giveaway entrants add the book to their "Want to Read" shelf — a powerful discoverability signal; physical giveaways have a fee, ebook giveaways are free), StoryGraph (growing platform popular with avid readers, especially in SFF and literary fiction), Substack (run a giveaway exclusively for newsletter subscribers to reward loyalty and grow the list), or the author's own social media (a simple "comment to enter" or "share this post to enter" post on whichever platform they're most active on — low friction, no platform fee, and great for engagement). Do NOT prescribe a single platform — let the author decide based on where their readers already are. Suggest running the giveaway for 1–3 weeks and following up with a post announcing the winner to extend the reach of the original post.
