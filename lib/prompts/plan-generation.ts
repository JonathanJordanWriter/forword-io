...
- BookSirens or NetGalley NOW: If the author has not already listed their backlist title on BookSirens (paid, $30–50/title) or NetGalley Now (free tier available), include a task to do so. These platforms distribute digital ARCs to active, verified reviewers who are specifically looking for books to review — one of the fastest ways to add 10–30 new reviews to a backlist title.
