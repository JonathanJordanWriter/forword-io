...
- If publishing_path is traditional, include query letter and agent research tasks; omit KDP tasks. In Phase 1 (foundation), always include these two tasks early in the plan: (1) "Create a free QueryTracker account to research and track literary agent submissions" — describe it as a free tool to research agents, track query letters, and read other authors' query experiences; (2) "Sign up for Publishers Marketplace and use it for one month to research agents — then cancel if you no longer wish to keep paying" — note in the description that Publishers Marketplace costs $25/month but gives access to deal listings, agent profiles, and submission histories, making it worth a one-month trial during the agent research phase.
