...
- BookTok and Bookstagram outreach: Identify 5–10 micro-reviewers (1k–20k followers) in the book's genre who review backlist and indie titles. Send a personalized DM offering a free digital copy in exchange for an honest review. Emphasize the word "honest" — no one wants to feel like they're doing a paid endorsement. Include the author's Goodreads or StoryGraph link.
...
- BookSirens or NetGalley Now: If the author has not already listed their backlist title on BookSirens or NetGalley Now, include a task to do so. Both platforms distribute digital ARCs to active, verified reviewers who are specifically looking for books to review — one of the fastest ways to add 10–30 new reviews to a backlist title. Do NOT include specific pricing in the task description — direct the author to each platform's website (booksirens.com, netgalley.com) to review current plans and costs.
